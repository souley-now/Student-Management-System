...
public class CourseTest {
    ...
    public void testAddStudent() {
        ...
        assertFalse(course.addStudent("student3")); 
    }
    ...
    public void testRemoveStudent() {
        ...
        assertFalse(course.removeStudent("student2")); 
    }
    ...
    public void testHasTimeConflict() {
        ...
        Course course3 = new Course("CIT593", "Algorithms", "Dr. White", "TF", "10:00", "11:30", 2);

        assertTrue(course1.hasTimeConflict(course2)); 
        assertFalse(course1.hasTimeConflict(course3)); 
    }
